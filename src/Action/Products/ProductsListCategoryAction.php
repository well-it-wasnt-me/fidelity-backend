 ...
 * Action.
 */
final class ProductsListCategoryAction
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $prodByCat = $this->productsRepository->listProdByCategory($args['category_id']);

        return $this->responder->withJson($response, $prodByCat);
    }
}
