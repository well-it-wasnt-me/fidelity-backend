 ...
 * Action.
 */
final class CategoriesListAction
{
     ...
     * The constructor.
     *
     * @param PrizesRepository $prizesRepository The Repository
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
    {
        ...
        $catList = $this->prizesRepository->listCategories();

        return $this->responder->withJson($response, $catList);
    }
}
